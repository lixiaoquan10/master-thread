...
linkageTestSerialWorker::linkageTestSerialWorker(QSerialPort *port) : m_linkageTestSerialPort(port)
{
    if(!m_linkageTestSerialPort)
        return;
    if(m_linkageTestSerialPort->open(QIODevice::ReadWrite))
    {
        connect(m_linkageTestSerialPort, &QSerialPort::readyRead, this, &linkageTestSerialWorker::readData);
        connect(m_linkageTestSerialPort, &QSerialPort::errorOccurred, this, &linkageTestSerialWorker::onErrorOccurred);
    }
}
...
void linkageTestSerialWorker::onErrorOccurred(QSerialPort::SerialPortError error) {
